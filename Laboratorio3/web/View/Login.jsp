    ...
    <div class="container-login">
        <div class="wrap-login">
            <form class="login-form validate-form" id="formLogin" action="${pageContext.request.contextPath}/UserServlet" method="post">
                <span class="login-form-title">LOGEO</span>
                ...
                <div class="wrap-input100" data-validate="contrasenia incorrecto">
                ...
                <div class="container-login-form-btn">
                    <div class="wrap-login-form-btn">
                        ...
                        <button type="submit" name="btnAction" value="2" class="login-form-btn">Entrar</button>
                    </div>
                </div>
                <div style="padding: 8px 0px 0px 8px;">
                    <span>No te has registrado?<a href="Register.jsp"> Hazlo aqui!</a></span>
                </div>
            </form>
        </div>
    </div>     
